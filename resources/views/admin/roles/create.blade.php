    ...
    <div class="card">
        ...
        <div class="card-body">
            {!! Form::open(['route'=>['rol.store'], 'method'=>'POST']) !!}
                @csrf
                <div class="row">
                    <x-adminlte-input type="text" name="nombre" id="nombre" label="NOMBRE DEL ROL" placeholder="Ingresa nombre de rol" label-class="text-orange" value="{{old('nombre')}}" fgroup-class="col-md-12" >
